...
public class Ldap {
    ...
    private ConexionLDAP conexion;

    public Ldap(ConexionLDAP conexion) {
    ...
    @SuppressWarnings("rawtypes")
    public Map<String, String> obtenerDatosEh(String eHumano, String[] datosReturn) throws  Exception {
        Map<String, String> mapa = new HashMap<String, String>();
        try {
            this.ctx = new InitialLdapContext(this.env, null);
            ...
            this.searchFilter = ("(&(objectCategory=person)(objectClass=user)(initials=" + eHumano + "))");
