...
@FacesValidator("regexResolverValidatorOptional")
public class RegexResolverValidatorOptional implements Validator {
    ...
    public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) {
        ...
        if (optValue.isPresent() && !optValue.get().trim().isEmpty()) {
            Matcher matcher = mask.matcher(optValue.get().trim());
            if (!matcher.matches()) {
