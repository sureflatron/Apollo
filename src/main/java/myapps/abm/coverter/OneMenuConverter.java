...
@FacesConverter("oneMenuConverter")
public class OneMenuConverter implements Converter {
    @Override
    public Object getAsObject(final FacesContext facesContext, final UIComponent uiComponent, final String objectString) {
        if (objectString == null) {
            return null;
        }
        return fromSelect(uiComponent, objectString);
    }
